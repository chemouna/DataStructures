...
/* package ds-haskell-0.1.0.0 */
#define VERSION_ds_haskell "0.1.0.0"
#define MIN_VERSION_ds_haskell(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "ds-haskell-0.1.0.0-AkCf29x7CNWFodr3PxEOfR"

#define CURRENT_PACKAGE_KEY "ds-haskell-0.1.0.0-AkCf29x7CNWFodr3PxEOfR"
